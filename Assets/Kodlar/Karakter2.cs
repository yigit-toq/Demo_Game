...
public class Karakter2 : MonoBehaviour {
	...
	private static Karakter2 karakterOrn;
	public static Karakter2 karakter 
	{
		get{
			if(karakterOrn == null)
			{
				karakterOrn = FindObjectOfType<Karakter2> ();
			}
			return karakterOrn;
		}
	}
	...
	void OnCollisionEnter2D (Collision2D other)
	{
		...
		{
			öldün = true;
			transform.position = new Vector3 (-38.75f, -10.25f, 0);
			öldün = false;
		}
	}
